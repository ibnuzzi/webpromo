          ...
          <div class="row">
            <div class="col-md-5">
              <div class="project-info-box mt-0">
                ...
                <p class="mb-0">Rekomendasi makan siang istimewa bareng keluarga atau temen kantor nih.
                  Kamu bisa pesan paket Special Hoka Ramen di HokBen. Bebas pilih Hokkaido Miso atau Tori Paitan sudah
                  termasuk Fried Dumpling plus Ocha*, only 55k nett* . Yang terbaru ada pilihan Spicy Ramen juga lho,
                  yang #pedasnyanampol!!!
                  Cuss langsung dine in ke store HokBen terdekat. Sama-sama kita #ngerameninhokben</p>
              </div><!-- / project-info-box -->

              <div class="project-info-box">
                <p><b>Nama Promotor : </b>Stephan</p>
                <p><b>Kategori Promo : </b>Makanan</p>
                <p><b>Masa Promo : </b>1 - 18 Februari 2023</p>
                <p><b>Limit Promo : </b>100 Orang</p>
                <a href="/list-promo">
                  <button class="btn btn-success mb-1" style="border-radius: 5px;"
                      type="button">Terima Promo</button>
              </a>
              <a href="/promo-ditolak">
                <button class="btn btn-danger" style="border-radius: 5px;" type="button">Tolak
                  Promo</button>
              </a>
            ...
            <div class="col-md-7">
              <img src="../assets/images/makanan 1.jpg" alt="project-image" class="rounded">
              <div class="project-info-box">
                <p><b>Nama Brand : </b>Hokben</p>
                <p><b>Nama Promo: </b> Promo Hokben Spesial Hoka Ramen Mulai Dari Rp 55K</p>
              </div><!-- / project-info-box -->
            </div><!-- / column -->
          </div>
        </div>

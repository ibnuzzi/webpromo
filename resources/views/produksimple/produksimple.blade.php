            ...
            <div class="header-content">
                <div class="header-media-group">
                    <button class="header-user"><img
                            ...
                            alt="user" /></button><a href="index.html"><img src="images/removepromo.png"
                            alt="logo" /></a><button class="header-src"><i class="fas fa-search"></i></button>
                </div>
                <a href="index.html" class="header-logo"><img style="height:80px;"
                        src="
                    {{ asset('template/mironmahmud.com/greeny/assets/ltr/images/removepromo.png') }}
                    "
                        alt="logo" /></a>
                    ...
                    <div class="col">
                        <div class="product-card">
                            ...
                            <div class="product-content">
                                ...
                                <p style="color: red;">Berakhir {{ $item->masapromo }}</p>

                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr class="border-bottom-secondary">
                          ...
                          <td>
                            <a href="product.html">
                              <button class=" btn-info mb-1" style="border-radius: 5px;" type="button">Detail Promo</button>
                          </a>

                                <button class="btn-success mb-1" style="border-radius: 5px;" type="button">Terima Promo</button>


                            <button class="btn-danger" style="border-radius: 5px;" type="button">Tolak Promo</button>
                        </td>
                        </tr>
                        <tr class="border-bottom-secondary">
                          <th scope="row">2</th>
                          ...
                          <td>100 Orang</td>
                          <td><img src="../assets/images/promo/makanan11.jpg" width="100%" alt=""></td>
                        ...
                        <tr class="border-bottom-secondary">
                          ...
                          <td>1 - 28 Februari 2023</td>
                          <td>150 Orang</td>
                          <td><img src="../assets/images/promo/hokben1.jpg" width="100%" alt=""></td>

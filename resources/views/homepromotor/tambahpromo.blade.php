...
<body>
                                ...
                                <form action="/insertpromo" method="post" enctype="multipart/form-data">
                                            ...
                                            <select name="kategoripromo" class="form-control">
                                                ...
                                                @foreach ($data as $kategori)
                                                    <option value="{{ $kategori->id }}"
                                                        {{ old('kategoripromo') == $kategori->id ? 'selected' : '' }}>
                                                        {{ $kategori->kategori }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 col-lg-12">
                                        <div class="form-group"><label class="form-label">Masa Promo</label><input
                                                class="form-control" type="date" value="{{ old('masapromo') }}"
                                                name="masapromo" placeholder="">
                                        </div>
                                    </div>
                                    @error('masapromo')
                                        <div class="alert alert-danger mb-3"> {{ $message }} </div>
                                    ...
                                    <div class="col-md-6 col-lg-12">
                                        <div class="form-group"><label class="form-label">Limit Promo</label><input
                                                class="form-control" type="number" value="{{ old('limit') }}"
                                            ...
                                            <div class="upload__box">
                                                <div class="upload__btn-box">
                                                    <label class="upload__btn">
                                                        <p class="mb-0">Unggah Sampul Produk</p>
                                                        <input name="sampul" type="file" class="upload__file" onchange="previewSampul(event)">
                                                    </label>
                                                </div>
                                                <div class="upload__img-wrap">
                                                    @if (old('sampul'))
                                                        <img src="{{ asset('sampul/' . old('sampul')) }}" alt="Sampul produk">
                                                    @endif
                                                </div>
                                            </div>
                                    </div>
    ...
    <script>
        function previewImages(event) {
            ...
            var preview = document.querySelector('.upload__img-wrap');
            preview.innerHTML = '';
...
<script>
    ...
    document.getElementById("sampul").addEventListener("change", previewSampul);
</script>

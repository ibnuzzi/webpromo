<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from mironmahmud.com/greeny/assets/ltr/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 06:53:02 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Tentang Kami - GudangPromo</title>
    <link rel="icon" href="images/iconremove.png">
    ...
    <link rel="stylesheet" href="{{ asset('template/mironmahmud.com/greeny/assets/ltr/css/about.css')}}"/>
</head>
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-lg-4">
                    <ul class="header-top-list">
                        ...
                        <li><a href="/faq">kontak kami</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="header-content">
                <div class="header-media-group">
                    <button class="header-user"><img src="{{'template/mironmahmud.com/greeny/assets/ltr/images/user.png'}}" alt="user" /></button><a
                        href="home-category.html"><img src="{{'template/mironmahmud.com/greeny/assets/ltr/images/removepromo.png'}}" alt="logo" /></a><button
                        class="header-src"><i class="fas fa-search"></i></button>
                </div>
                <a href="home-category.html" class="header-logo"><img style="height:80px;" src="{{'template/mironmahmud.com/greeny/assets/ltr/images/removepromo.png'}}"
                        alt="logo" /></a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="about-content">
                        <h2>Tujuan Website Promosi Kami</h2>
                        <p>Website kami menyediakan wadah bagi promotor untuk mempromosikan produknya, serta membagikan
                            informasi mengenai produk, potongan harga berbagai macam promo dari berbagai macam barang
                            dengan banyak kategori, user dapat menerima informasi dengan cepat dan tepat, yang
                            diharapkan menarik user untuk membeli barang promo. </p>
                    </div>
                    <ul class="about-list">
                        <li>
                            <h3>1000</h3>
                            <h6>
                                pengguna terdaftar</h6>
                        </li>
                        <li>
                            <h3>20</h3>
                            <h6>pengunjung per hari</h6>
                        </li>
                        <li>
                            <h3>100</h3>
                            <h6>total promo</h6>
                ...
                <!-- <div class="col-lg-6">
                    <div class="about-img"><img src="images/about/01.jpg" alt="about"><img src="images/about/02.jpg"
                            alt="about"><img src="images/about/03.jpg" alt="about"><img src="images/about/04.jpg"
                            alt="about"></div>
                </div> -->
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="team-slider slider-arrow">
                        <li>
                            <figure class="team-media"><img src="{{ asset('team/aku.jpeg') }}" alt="team">
                            ...
                            <div class="team-meta">
                                <h5><a href="#">Muhammad Ibnu Zauzi</a></h5>

                            </div>
                        </li>
                        <li>
                            <figure class="team-media"><img src="{{asset('team/jihan.jpeg')}}" alt="team">
                                <div class="team-overlay"><a href="#" class="icofont-facebook facebook"></a><a
                                        href="#" class="icofont-twitter twitter"></a><a href="#"
                                        class="icofont-linkedin linkedin"></a></div>
                            </figure>
                            <div class="team-meta">
                                <h5><a href="#">Jihan Prahasti Saharani</a></h5>

                            </div>
                        </li>
                        <li>
                            <figure class="team-media"><img src="{{ asset('team/felix.jpg') }}" alt="team">
                                <div class="team-overlay"><a href="#" class="icofont-facebook facebook"></a><a
                                        href="#" class="icofont-twitter twitter"></a><a href="#"
                                        class="icofont-linkedin linkedin"></a></div>
                            </figure>
                            <div class="team-meta">
                                <h5><a href="#">Felix Alberta Jevon</a></h5>

                            </div>
                        </li>
                        <li>
                            <figure class="team-media"><img src="{{asset('team/nadia.jpeg')}}" alt="team">
                                <div class="team-overlay"><a href="#" class="icofont-facebook facebook"></a><a
                                        href="#" class="icofont-twitter twitter"></a><a href="#"
                                        class="icofont-linkedin linkedin"></a></div>
                            </figure>
                            <div class="team-meta">
                                <h5><a href="#">Nadia Stevani</a></h5>
            ...
            <div class="row">
                <div class="col-sm-6 col-xl-4">
                    <div class="footer-widget">
                        <a class="footer-logo" href="#"><img src="{{'template/mironmahmud.com/greeny/assets/ltr/images/removepromo.png'}}"
                                alt="logo" /></a>
...
<!-- Mirrored from mironmahmud.com/greeny/assets/ltr/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 06:53:06 GMT -->

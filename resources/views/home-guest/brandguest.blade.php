<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from mironmahmud.com/greeny/assets/ltr/brand-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 06:53:01 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Hokben - GudangPromo</title>
    ...
    <link rel="stylesheet" href="{{ asset('template/mironmahmud.com/greeny/assets/ltr/css/brand-single.css') }}">
</head>
...
<body>
                    ...
                    <div class="navbar-content">
                        <ul class="navbar-list">
                            <li class="navbar-item dropdown">
                                <a class="navbar-link" href="home-category.html">Beranda</a>
                            </li>
                            <!-- Product Link -->
    ...
    <section class="single-banner" style="background: url({{ asset('templatebanner/bannerwebpromosi.jpg') }}) no-repeat center;">
        <div class="container">
            <h2>{{ $banner->namamerek }}</h2>

        </div>
    </section>
    <div class="brand-single">
        <img src="{{ asset('/foto_merek/' . $banner->fotomerek) }}" alt="brand">
        <h3>Brand {{ $banner->namamerek }}</h3>
        <p>( {{ $jumlahpromo }} Promo )</p>
    </div>
                        ...
                        <div class="product-card">
                            <div class="product-media">
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                    class="product-image"><img href="/detpromo/{{ $row->id }}"
                                        src="{{ asset('sampul/' . $p->sampul) }}" alt="product"></a>
                            ...
                            <div class="product-content">
                                ...
                                <h6 class="product-name"><a
                                        href="/detpromo/{{ $row->id }}">{{ $p->namapromo }}</a>
                                </h6>
                                <p style="color: red;">Berakhir {{ $p->masapromo }}</p>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="footer-widget">
                        ...
                        <p class="footer-desc"><a style="color:red;">Gudang Promo</a> adalah suatu website yang
                            berisi tentang brbagai macam diskon dengan berbagai macam kategori. Website ini adalah
                            website resmi <a href="#">X-CODE</a> yang dibuat untuk memenuhi tugas Mini Project
                            bertemakan Promo.</p>

            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="contact-card"><i class="icofont-location-pin"></i>
                        <h4>Kantor pusat</h4>
                        <p>Malang Karangploso</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="contact-card active"><i class="icofont-phone"></i>
                        <h4>nomor telepon</h4>
                        <p><a href="#">(+62) 55 6778 9098 </a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="contact-card"><i class="icofont-email"></i>
                        <h4>email</h4>
                        <p><a href="#">x-code@example.com</a></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-map"><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15807.808378572216!2d112.606886!3d-7.900074!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7881c2c4637501%3A0x10433eaf1fb2fb4c!2sHummasoft%20Technology!5e0!3m2!1sid!2sid!4v1676815112431!5m2!1sid!2sid"width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
                </div>
                <div class="col-lg-6">
                    <form class="contact-form">
                        ...
                        <div class="form-group">
                            <div class="form-input-group"><textarea class="form-control"
                                    placeholder="Pesan Kamu"></textarea><i class="icofont-paragraph"></i></div>
                        </div><button type="submit" class="form-btn-group"><i class="fas fa-envelope"></i><span>Kirim
                                Pesan</span></button>
                    </form>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xl-4">
                            <div class="footer-widget">
                                <a class="footer-logo" href="#"><img src="{{'template/mironmahmud.com/greeny/assets/ltr/images/removepromo.png'}}" alt="logo" /></a>
                                <p class="footer-desc"><a style="color:red;">Gudang Promo</a> adalah suatu website yang
                                    berisi tentang
                                    brbagai macam diskon dengan berbagai macam kategori. Website ini adalah website
                                    resmi <a href="#">X-CODE</a> yang dibuat untuk memenuhi tugas Mini Project
                                    bertemakan Promo.</p>

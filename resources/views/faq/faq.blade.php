<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from mironmahmud.com/greeny/assets/ltr/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 06:52:37 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template/mironmahmud.com/greeny/assets/ltr/css/faq.css')}}">
</head>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-5">
                    <div class="header-top-welcome">
                        <p>Selamat datang dibantuan kami!</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="header-content">
                <div class="header-media-group"><button class="header-user"><img src="images/user.png"
                            alt="user"></button><a href="index.html"><img src="template/mironmahmud.com/greeny/assets/ltr/images/logo.png" alt="logo"></a><button
                        class="header-src"><i class="fas fa-search"></i></button></div><a href="index.html"
                    class="header-logo"><img src="{{ asset('template/mironmahmud.com/greeny/assets/ltr/images/removepromo.png') }}" alt="logo"></a>
                <form class="header-form"><input type="text" placeholder="Cari..."><button><i
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="faq-parent">
                        <div class="faq-child">
                            <div class="faq-que"><button>Bagaimana cara menghubungi Layanan Pelanggan?</button></div>
                            <div class="faq-ans">
                        ...
                        <div class="faq-child">
                            <div class="faq-que"><button>Respon situs web membutuhkan waktu,bagaimana cara meningkatkannya?</button></div>
                            <div class="faq-ans">
                                <p>Pastikan jaringan internet Anda berjalan dengan lancar</p>
                            </div>
                        </div>
                        <div class="faq-child">
                            <div class="faq-que"><button>Bagaimana cara membuat akun Promotor?</button></div>
                            <div class="faq-ans">
                                <p>1. Anda harus melakukan Register terlebih dahulu jika ingin menjadi seorang promotor</p>
                                <p>2. Masukkan Email dan Password sesuai Register Anda</p>
                                <p>3. Mulailah Login</p>
                                <p>4. Anda akan masuk kehalaman Beranda Promotor</p>
                            </div>
                        </div>
                        <div class="faq-child">
                            <div class="faq-que"><button>Saya tidak dapat menemukan jawaban atas pertanyaan saya</button></div>
                            <div class="faq-ans">
                                <p>Terima kasih atas pertanyaan anda, Anda bisa menghubungi kontak kami!</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from mironmahmud.com/greeny/assets/ltr/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 06:52:38 GMT -->

        ...
        <div class="container">
            <div class="header-content">
                ...
                <a href="home-category.html" class="header-logo"><img style="height:80px;" src="{{ asset('template/mironmahmud.com/greeny/assets/ltr/images/removepromo.png') }}"
                        alt="logo" /></a>
                        <form class="header-form" action="{{ route('promopending') }}" method="GET">
...
@else
    <a href="/profile" class="header-widget" title="My Account">
        <img src="{{ asset('template/mironmahmud.com/greeny/assets/ltr/images/user.png') }}" alt="user" />
    </a>
@endif
                        ...
                        {{-- <div class="navbar-info-group">
                            <div class="navbar-info">
                                <a href="/tambahpromo"><button class="btn btn-warning">
                                    ...
                                    <a href="/tambahkilat"><button class="btn btn-warning">
                                        <p style="color:white">+ Tambah Promo Kilatmu</p>
                                    </button></a>
    ...
    <section class="inner-section single-banner" style="background: url({{ asset('templatebanner/bannerwebpromosi.jpg') }}) no-repeat center;">
        <div class="container">
            <h2>Daftar Promo Yang Masih Menunggu Tinjauan Admin</h2>
        </div>
    </section>
                    ...
                    <div class="col">
                        <div class="product-card">
                            ...
                            <div class="product-content">
                                ...
                                <h6 class="mb-2">
                                    Status :
                                    @if ($promo->status == 0 && !$promo->pesan)
                                    <span class="badge bg-warning text-dark">Menunggu</span>
                                    @elseif($promo->status == 0 && $promo->pesan)
                                ...
                                <a class="deletesiswa" href="{{ Route('deletepromo', ['id' => $promo->id]) }}"
                                    type="button" data-nama="{{ $promo->namapromo }}">

    ...
    <header class="header-part">
        <div class="container">
            <div class="header-content">
                ...
                <a href="profile.html" class="header-widget" title="My Account"><img
                        src="{{ asset('template/mironmahmud.com/greeny/assets/ltr/images/user.png') }}"
                        alt="user" /></a>
                ...
                <div class="col-lg-12">
                    <div class="account-card">
                        <div class="account-title">
                            <h3 style="margin-left: 40%;">Edit Kilat</h3>
                        </div>
                        <div class="account-content">
                            <div class="row">
                                <form action="/updatekilat/{{ $data->id }}" method="post"
                                    ...
                                    <textarea class="form-control" name="deskripsipromo" id="Mysummernote" cols="30" rows="10">{!! $data->deskripsipromo!!}</textarea></div>
                                    </div>
                                    {{-- direlasikan --}}
                                    <div class="col-md-6 col-lg-12">
                                    ...
                                    <div class="col-md-6 col-lg-12">
                                        <div class="form-group"><label class="form-label">Limit Promo</label><input
                                                class="form-control" type="number" name="limitpromo" placeholder=""
                                                value="{{ $data->limitpromo }}"></div>
                                    </div>
                                    <div class="col-md-6 col-lg-12">
                                        <div class="form-group"><label class="form-label">Foto Promo</label><input
                                                class="form-control" type="file" multiple name="fotopromo"
                                                placeholder="" value="{{ $data->fotopromo }}">
                                            <img src="{{ asset('fotopromo/' . $data->fotopromo) }}" class="mt-2"
                                                alt="" width="200px">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <button class="btn btn-warning">Edit Kilat</button>
                                        <a style="color:black;" href="/berandapromotor"><div class="btn btn-warning">kembali</div></a>
                                    </div>
                                </form>
                            </div>
                        </div>
